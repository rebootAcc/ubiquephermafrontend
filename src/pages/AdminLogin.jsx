...
const AdminLogin = () => {
  ...
  return (
    <div className="flex justify-center h-[100vh] overflow-y-scroll bg-no-repeat bg-cover bg-center overflow-x-hidden items-center">
      <div className="lg:w-[40%] xl:w-[35%] sm:w-[95%] md:w-[60%] h-fit py-5 lg:px-6 xl:px-16 gap-8 flex flex-col boxsh rounded-lg text-black bg-transparent">
        <div className="flex flex-col gap-8">
          <div className="flex justify-center items-center text-[#63B263] text-2xl font-bold">
            <img src="/logo.png" alt="ubique-logo" className="h-[4rem]" />
          </div>
        ...
        >
          <div className="flex flex-col gap-2 font-semibold text-black">
            ...
            <input
              ...
              className="bg-transparent border border-[#B5B5B5] text-custom-green rounded-md sm:h-[2.5rem] xl:h-[3.5rem] p-2 text-lg focus:outline-[#5BC0DE] focus:outline-none"
            />
            {emailorphoneError && (
          ...
          <div className="flex flex-col font-semibold text-[black] gap-2">
            ...
            <div className="flex sm:h-[2.5rem] xl:h-[3.5rem] w-full items-center justify-between border-[#B5B5B5] rounded-md bg-transparent border">
              <input
                ...
                className="bg-transparent  rounded-sm sm:h-[2.5rem] xl:h-[3.5rem] p-2 w-full text-custom-green text-lg focus:outline-[#5BC0DE] focus:outline-none"
              />
              <div
          ...
          <div className="flex flex-col">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full rounded-md sm:h-[2.5rem] xl:h-[3.5rem] flex justify-center items-center text-white text-lg font-medium bg-custom-green"
              >
                {loading ? "Wait..." : "Login"}
              </button>
            </div>
