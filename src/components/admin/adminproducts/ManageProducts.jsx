        ...
        <div className="flex flex-row justify-between items-center">
          ...
          <div className="flex flex-row gap-4 items-center">
            ...
            <button
              ...
              className="xlg:h-[2.5rem] sm:h-[2rem] px-6 sm:text-sm xlg:text-base bg-custom-blue gap-2 flex justify-center items-center text-white rounded-md"
            >
          ...
          {loading ? (
            ...
            <div className="flex flex-col">
              {noDataMessage ? (
                ...
                <>
                  <div className="flex flex-row px-2 py-4 gap-4 font-medium sm:text-sm xlg:text-base bg-custom-blue text-white w-full border-b">
